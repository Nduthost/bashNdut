...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY NDUTVPS             [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "Ibnsfyn" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Weh Ke NdutVps No +6285789116062${NC}"
    exit 1
  fi
  clear
}
...
wget https://thema.elevate.web.id/nebula.blueprint
...
echo -e "${BLUE} | \| |__| |_  _| |\ \ / / __ ___"
echo -e "${GREE} | .` / _` | || |  _\ V / '_ (_-<"
echo -e "${YELLOW} |_|\_\__,_|\_,_|\__|\_/| .__/__/"
echo -e "${RED}                        |_|"
echo -e "                                                       "
